...
class MachineBreakdownRAG:
    def __init__(self, user_role: str = 'master'):
        # Local model setup
        model_path = r"C:/Users/Jeyavarman Murugan/.cache/huggingface/hub/models--deepseek-ai--DeepSeek-R1-0528-Qwen3-8B/snapshots/5cf2132abc99cad020ac570b19d031efec650f2b"
        ...
        # Create pipeline with similar parameters to the API version
        pipe = pipeline(
            "text-generation",
            model=model,
            tokenizer=tokenizer,
